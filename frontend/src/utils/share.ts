...
const BASE_URL = "https://ipredict-stellar.vercel.app";
 ...
 *
 * Example output:
 *   "I just bet 100 XLM that Will ETH flip BTC? on iPredict!
 *    Think I'm wrong? 👉 https://ipredict-stellar.vercel.app/markets/1?ref=GABC..."
 */
export function buildShareText(
  ...
  return `I just bet ${amount} XLM ${side} on "${question}" on iPredict! Think I'm wrong? 👉 ${marketUrl}`;
}
